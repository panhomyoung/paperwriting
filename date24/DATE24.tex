...
% \thanks{*Corresponding authors: chuzhufei@nbu.edu.cn, yangfan@fudan.edu.cn}
% \author{\IEEEauthorblockN{Hongyang Pan$^{1}$, Ruibing Zhang$^{2}$, Yinshui Xia$^{2}$, Lunyao Wang$^{2}$, Zhufei Chu$^{2}$$^{\ast}$, Fan Yang$^{1}$$^{\ast}$, and Xuan Zeng$^{1}$}
% $^{1}$State Key Lab of ASIC \& System, School of Microelectronics, Fudan University, Shanghai, China\\ 
% $^{2}$Faculty of Electrical Engineering \& Computer Science, Ningbo University, Ningbo, China}
\maketitle
\vspace{-10em}
...
\begin{figure}[t]
  ...
  \subfigure[example logic circuit]{
      \label{fig:sim1}
      \includegraphics[width=0.29\textwidth]{picture/sim1.pdf}}
      \hspace{15mm}
  \subfigure[cutting algorithm]{
      \label{fig:sim2}
      \includegraphics[width=0.29\textwidth]{picture/sim2.pdf}}
...
\begin{table*}[t]
  ...
  \toprule
  \multirow{2}{*}{Benchmark} & \multicolumn{4}{c}{Statistics} & \multicolumn{2}{c}{SAT calls} & \multicolumn{2}{c}{Total SAT calls} & \multicolumn{2}{c}{Simulation} & \multicolumn{3}{c}{Total runtime} \cr
...
\begin{thebibliography}{00}
    ...
    \bibitem{exp2} IWLS 2005 benchmarks https://iwls.org/iwls2005/benchmarks.html.
\end{thebibliography}
